        ...
        <div class="col-md-12">
          <div class="col-middle">
            <div class="text-center">
              <h1 class="error-number">CONCLUÍDO</h1>
              <h2></h2>
              <p></a>
              </p>
              <div class="mid_center">
                <h3>Caso clínico enviado para análise.</h3>
                <form>
                  <div class="col-xs-12 form-group pull-right top_search">
                    <div class="input-group">
                      <a href="<?php echo base_url('acesso/sair/'); ?>" class="btn btn-danger btn-lg">Clique aqui para sair do sistema</a>
                    </div>
                  </div>
                </form>
              </div>
