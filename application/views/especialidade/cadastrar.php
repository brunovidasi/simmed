<div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Cadastrar Nova Especialidade Médica</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left input_mask" role="form" method="post" action="<?php echo base_url('especialidade/insert/'); ?>">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-success">Cadastrar Especialidade Médica</button>
                        </div>
                      </div>
